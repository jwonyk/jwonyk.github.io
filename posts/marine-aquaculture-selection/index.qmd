...
## Data Preparation and Suitability Modeling
#### Analysis Setup

First, we are going to clear the environment and load necessary packages.
...
Oysters require relatively warm sea surface temperatures and moderate depths, making their potential habitat strongly influenced by latitudinal temperature gradients along the West Coast. Below, I visualize how these environmental constraints translate into regional differences in oyster aquaculture suitability across EEZs, highlighting areas where conditions are most favorable for oyster growth and infrastructure deployment.
...
## Applying the Suitability Model to Multiple Species
To demonstrate that this suitability framework is not species-specific, the workflow was generalized into a reusable function. This approach allows different environmental thresholds to be applied while keeping the underlying spatial processing steps consistent. By changing only temperature and depth constraints, the same modeling framework can be used to evaluate suitability for multiple aquaculture species.
